    ...
    return(
        ...
        {message && <p className={`${colorMsg} text-center text-sm`}>{message}</p>}
          ...
          <div className="w-1/2 relative">
              <select name='maloai' value={formData.maloai}  onChange={handleChange} className="block appearance-none text-sm w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1.5 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
            ...
            <div className="w-1/2 relative ml-2">
              <select name='mansx' value={formData.mansx} onChange={handleChange} className="block appearance-none text-sm w-full bg-white border border-gray-400 hover:border-gray-500 px-2 py-1.5 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
