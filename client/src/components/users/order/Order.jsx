                ...
                <div className="max-w-5xl mx-auto mt-10 bg-white rounded-lg shadow">
                    ...
                    <div className="p-4 border-b bg-gray-100">
                        <div className="grid grid-cols-4 sm:grid-cols-12 gap-4 text-sm font-medium text-gray-600">
                            ...
                            <p className="hidden sm:block col-span-3 text-center">Sản phẩm đặt</p>
                            <p className="hidden sm:block col-span-2 text-center">Đơn vị vận chuyển</p>
                            <p className="hidden sm:block col-span-3 text-center">Tổng giá</p>
                    ...
                    <div key={index} className="p-4 border-b">
                        <div className="grid grid-cols-4 sm:grid-cols-12 gap-4 text-sm items-center font-medium text-gray-600">
                            ...
                            <p className="hidden sm:block col-span-2 text-center">{order.tendvvc}</p>
                            <p className="hidden sm:block col-span-3 text-center">{formatCurrency(order.tonggia)}</p>
